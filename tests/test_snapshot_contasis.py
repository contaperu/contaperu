...
CASOS: list[tuple[str, dict, bool, dict | None]] = [
    ...
    ("venta_centro_costo_2", dict(cuenta_contable="701101"), True, CENTRO_2),
    ("venta_plan_corto", dict(cuenta_contable="70121"), True, PLAN_CORTO),
    ("venta_boleta_con_dni", dict(tipo_cp="03", serie="B001", numero="9", cuenta_contable="701101",
                                  contraparte_tipo_doc="1", contraparte_doc="45678912",
                                  contraparte_nombre="QUISPE MAMANI ROSA ELENA"), True, None),
    ("venta_usd", dict(cuenta_contable="701101", moneda="USD", tipo_cambio="3.55"), True, None),
    ("venta_nota_de_credito", dict(NC, cuenta_contable="701101"), True, None),
    ("venta_exportacion", dict(cuenta_contable="701101", base_gravada="0", igv="0", exportacion="1000", total="1000"),
     True, None),
