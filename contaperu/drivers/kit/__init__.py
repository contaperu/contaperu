...
Hasta la 0.10 esto vivía en `contaperu/formato.py`, que sigue resolviendo con aviso. Las microdecisiones son OPCIONES y
no código: así se itera con el reporte de SUNAT o del sistema en la mano sin tocar los drivers.
"""
from . import celdas, xlsx
...
__all__ = ["Opciones", "OpcionesArchivo", "armar_linea", "celdas", "formatear_cambio", "formatear_fecha",
           "formatear_monto", "formatear_numero", "negativo", "sanear", "xlsx"]
